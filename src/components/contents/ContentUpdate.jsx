...
const ContentUpdate = () => {
  ...
  useEffect(() => {
    ...
    if (contents.content) {
      nicknameRef.current.value = contents.content.nickname;
      contentTitleRef.current.value = contents.content.contentTitle;
      contentWhyRef.current.value = contents.content.contentWhy;
      contentHowRef.current.value = contents.content.contentHow;
      contentWhenRef.current.value = contents.content.contentWhen;
    }
